{
  ...
  "States": {
    "Extract_1": {
      "Comment": "APRM DELTA : ICEXT_GLB_I_VOICE.txt → sdbtdir3_aprm_dbo.sap_glb_delta_voice",
      "Type": "Task",
      "Resource": "arn:aws:states:::glue:startJobRun.sync",
      "Parameters": {
        "JobName.$": "States.Format('{}-aprm_det_gt-gljo-extract_1',$.env_prefix)",
        "Arguments": {
        }
      },
      "Catch": [
    ...
    "Extract_2": {
      "Comment": "APRM DELTA : SAP_REPORT_GLB_DELTA.CSV → sdbtdir3_aprm_dbo.sap_report_glb_delta_voice",
      "Type": "Task",
      "Resource": "arn:aws:states:::glue:startJobRun.sync",
      "Parameters": {
        "JobName.$": "States.Format('{}-aprm_det_gt-gljo-extract_2',$.env_prefix)",
        "Arguments": {
        }
      },
      "Catch": [
    ...
    "Extract_3": {
      "Comment": "APRM DELTA : SAP_REPORT_GLB_FINAL.CSV → sdbtdir3_aprm_dbo.sap_report_glb_final_voice",
      "Type": "Task",
      "Resource": "arn:aws:states:::glue:startJobRun.sync",
      "Parameters": {
        "JobName.$": "States.Format('{}-aprm_det_gt-gljo-extract_3',$.env_prefix)",
        "Arguments": {
        }
      },
      "Catch": [
