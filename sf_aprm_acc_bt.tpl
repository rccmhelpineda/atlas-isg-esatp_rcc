{
  "Comment": "APRM Processing. Bayan",
  "StartAt": "Extract_1",
  "States": {
    "Extract_1": {
      "Comment": "APRM ACCRUAL Bayan : ICEXT_BYN_A_VOICE.txt → sdbtdir3_aprm_dbo.icext_byn_a_voice",
      "Type": "Task",
      "Resource": "arn:aws:states:::glue:startJobRun.sync",
      "Parameters": {
        "JobName.$": "States.Format('{}-aprm_acc_bt-gljo-extract_1',$.env_prefix)",
        "Arguments": {
        }
      },
      "Catch": [
    ...
    "Extract_2": {
      "Comment": "APRM ACCRUAL Bayan : ICEXT_BYN_A_VOICE_OUTPUT.TXT → sdbtdir3_aprm_dbo.icext_byn_a_voice_output",
      "Type": "Task",
      "Resource": "arn:aws:states:::glue:startJobRun.sync",
      "Parameters": {
    ...
    "Extract_3": {
      "Comment": "APRM ACCRUAL Bayan : SAP_REPORT_BYN_ACCRUAL.CSV → sdbtdir3_aprm_dbo.sap_report_byn_accrual",
      "Type": "Task",
      "Resource": "arn:aws:states:::glue:startJobRun.sync",
      "Parameters": {
        "JobName.$": "States.Format('{}-aprm_acc_bt-gljo-extract_3',$.env_prefix)",
        "Arguments": {
        }
      },
      "Catch": [
