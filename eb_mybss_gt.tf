##########  BAYANTEL ######## 
module "eventbridge_bss_bc_gt_1" {
  ...
  depends_on = [module.stepfunctions_bss_bc_gt]
  name = "bss_bc1_gt"
  target_type = "stepfunctions"
  step_functions = "${var.env_prefix}-bss_bc_gt-sf"

  schedule_expression_stepfunctions = "cron(40 7 12 * ? *)"
  targets = [{
      name = "${var.env_prefix}-bss_bc_gt-sf",
      type = "stepfunctions",
      input = jsonencode({
        CODE  = "EOC1",
        BCNUM = "1",
...
module "eventbridge_bss_bc_gt_2" {
  source = "./modules/aws-eventbridge"
...
module "eventbridge_bss_bc_gt_3" {
  source = "./modules/aws-eventbridge"
...
module "eventbridge_bss_bc_gt_4" {
  source = "./modules/aws-eventbridge"
...
module "eventbridge_bss_bc_gt_5" {
  source = "./modules/aws-eventbridge"
...
module "eventbridge_bss_bc_gt_6" {
  source = "./modules/aws-eventbridge"
...
module "eventbridge_bss_bc_gt_7" {
  source = "./modules/aws-eventbridge"
...
module "eventbridge_bss_bc_gt_8" {
  source = "./modules/aws-eventbridge"
...
module "eventbridge_bss_bc_gt_9" {
  source = "./modules/aws-eventbridge"
...
module "eventbridge_bss_bc_gt_10" {
  source = "./modules/aws-eventbridge"
...
module "eventbridge_bss_bc_gt_11" {
  source = "./modules/aws-eventbridge"
...
module "eventbridge_bss_eom_gt" {
  ...
  name = "bss_eom_gtx"
  target_type = "stepfunctions"
  step_functions = "${var.env_prefix}-bss_eom_gt-sf"

  schedule_expression_stepfunctions = "cron(15 3 3 * ? *)"
  targets = [{
      name = "${var.env_prefix}-bss_eom_gt-sf",
      type = "stepfunctions",
      input = jsonencode({
        CODE  = "EOM",
        BCNUM = "0",
