  ...
  "States": {
    ...
    "Load_BSAK": {
      ...
      "Parameters": {
        ...
        "Arguments": {
          "--s4_table_name": "bsak",   
          "--input_file_name": "from_SAP/for_ingestion/bsak_output.json"
        }
      },
      "Catch": [
        {
    ...
    "Notify_Success": {
      ...
      "Parameters": {
        ...
        "Input": {
          "email_subject": "[SUCCESS] Daily ingestion of BSAK",
          "email_body": "✅ Processing Complete: Successfully synced S4HANA BSAK table."
        }
      },
      "End": true
    },
    ...
    "Notify_Fail": {
      ...
      "Parameters": {
        "StateMachineArn.$": "States.Format('arn:aws:states:{}:{}:stateMachine:{}-notifier-sf','${aws_region}','${aws_account_id}',$.env_prefix)",
        "Input": {
          "email_subject": "[FAILED] Daily ingestion of BSAK",
