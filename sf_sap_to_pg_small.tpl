  ...
  "States": {
    ...
    "Load_AUFK": {
      ...
      "Parameters": {
        ...
        "Arguments": {
          "--table_name": "aufk",
          "--nonstring_schema": "{\"user4\": \"numeric\", \"cpd_updat\": \"numeric\", \"aufk_status\": \"smallint\"}"
        }
      },
      "Catch": [
        {
    ...
    "Load_DSPCOMMONTRACE_EVENTDATA": {
      ...
      "Parameters": {
        ...
        "Arguments": {
          "--table_name": "dspcommontrace_eventdata",
          "--nonstring_schema": "{\"id\":\"integer\", \"tsqlcommand\":\"text\", \"changedon\":\"timestamp without time zone\"}"
        }
      },
      "Catch": [
        {
    ...
    "Load_LFA1": {
      ...
      "Parameters": {
        ...
        "Arguments": {
          "--table_name": "lfa1",
          "--nonstring_schema": "{\"j_sc_capital\":\"numeric\", \"staging_time\":\"numeric\"}"
        }
      },
      "Catch": [
        {
    ...
    "Load_LFB1": {
      ...
      "Parameters": {
        ...
        "Arguments": {
          "--table_name": "lfb1",
          "--nonstring_schema": "{\"webtr\":\"numeric\", \"kultg\":\"numeric\", \"basis_pnt\":\"numeric\", \"wrbtr\":\"numeric\", \"share_in_foreign\":\"numeric\"}"
        }
      },
      "Catch": [
        {
    ...
    "Load_LFBW": {
      ...
      "Parameters": {
        ...
        "Arguments": {
          "--table_name": "lfbw",
          "--nonstring_schema": "{\"wt_exrt\":\"numeric\"}"
        }
      },
      "Catch": [
        {
    ...
    "Load_SKA1": {
      ...
      "Parameters": {
        ...
        "Arguments": {
          "--table_name": "ska1",
          "--nonstring_schema": "{\"last_changed_ts\":\"numeric\"}"
        }
      },
      "Catch": [
        {
    ...
    "Load_T059Z": {
      ...
      "Parameters": {
        ...
        "Arguments": {
          "--table_name": "t059z",
          "--nonstring_schema": "{\"qproz\":\"numeric\", \"qsatz\":\"numeric\", \"qsatr\":\"numeric\", \"wt_ratez\":\"smallint\", \"wt_raten\":\"smallint\"}"
        }
      },
      "Catch": [
        {
    ...
    "Load_TCURR": {
      ...
      "Parameters": {
        ...
        "Arguments": {
          "--table_name": "tcurr",
          "--nonstring_schema": "{\"ukurs\":\"numeric\", \"ffact\":\"numeric\", \"tfact\":\"numeric\"}"
        }
      },
      "Catch": [
        {
    ...
    "Load_ZFFI_0346": {
      ...
      "Parameters": {
        ...
        "Arguments": {
          "--table_name": "zffi_0346",
          "--nonstring_schema": "{\"zoct_rate\":\"numeric\", \"zvat_rate\":\"numeric\"}"
        }
      },
      "Catch": [
        {
    ...
    "Extract_ZFFI_ISMSACCRUAL": {
      ...
      "Next": "Load_ZFFI_ISMSACCRUAL"
    },
    "Load_ZFFI_ISMSACCRUAL": {
      "Comment": "Full extract of SAPPRD.ZFFI_ISMSACCRUAL",
      "Type": "Task",
      "Resource": "arn:aws:states:::glue:startJobRun.sync",
      "Parameters": {
        ...
        "Arguments": {
          "--table_name": "zffi_ismsaccrual",
          "--nonstring_schema": "{\"zrate\":\"numeric\"}"
        }
      },
      "Catch": [
        {
    ...
    "Load_ZFFI_RATES_SYNIV": {
      ...
      "Parameters": {
        ...
        "Arguments": {
          "--table_name": "zffi_rates_syniv",
          "--nonstring_schema": "{\"usd_sdr\":\"numeric\", \"eur_sdr\":\"numeric\", \"gbp_sdr\":\"numeric\", \"hkd_sdr\":\"numeric\", \"chf_sdr\":\"numeric\", \"eur_usd\":\"numeric\", \"gbp_usd\":\"numeric\", \"chf_usd\":\"numeric\", \"hkd_usd\":\"numeric\"}"
        }
      },
      "Catch": [
        {
    ...
    "Load_ZTF0158": {
      ...
      "Parameters": {
        ...
        "Arguments": {
          "--table_name": "ztf0158",
          "--nonstring_schema": "{\"zdisc\":\"numeric\"}"
        }
      },
      "Catch": [
        {
    ...
    "Load_ZTF0455S": {
      ...
      "Parameters": {
        ...
        "Arguments": {
          "--table_name": "ztf0455s",
          "--nonstring_schema": "{\"taxrate\":\"numeric\",\"averate\":\"numeric\"}"
        }
      },
      "Catch": [
        {
