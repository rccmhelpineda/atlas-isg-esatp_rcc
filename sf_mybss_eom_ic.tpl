{
  ...
  "States": {
    "Extract_1": {
      ...
      "Parameters": {
        "JobName.$": "States.Format('{}-mybss_ic_eom-gljo-extract_1',$.env_prefix)",
        "Arguments": {
        }
      },
      "Catch": [
    ...
    "Extract_2": {
      ...
      "Resource": "arn:aws:states:::glue:startJobRun.sync",
      "Parameters": {
        "JobName.$": "States.Format('{}-mybss_ic_eom-gljo-extract_2',$.env_prefix)",
        "Arguments": {
        }
      },
      "Catch": [
    ...
    "Extract_3": {
      ...
      "Resource": "arn:aws:states:::glue:startJobRun.sync",
      "Parameters": {
        "JobName.$": "States.Format('{}-mybss_ic_eom-gljo-extract_3',$.env_prefix)",
        "Arguments": {
          "--CODE.$": "$.CODE",
          "--BCNUM.$": "$.BCNUM",
          "--BC.$": "$.BC"
    ...
    "Fail": {
      "Type": "Fail",
      "Error": "BSS End of Month Pipeline -  Innove",
