{
  ...
  "States": {
    "Extract_1": {
      "Comment": "APRM DELTA : ICEXT_BYN_I_VOICE.txt → sdbtdir3_aprm_dbo.sap_byn_delta_voice",
      "Type": "Task",
      "Resource": "arn:aws:states:::glue:startJobRun.sync",
      "Parameters": {
        "JobName.$": "States.Format('{}-aprm_det_bt-gljo-extract_1',$.env_prefix)",
        "Arguments": {
        }
      },
      "Catch": [
    ...
    "Extract_2": {
      "Comment": "APRM DELTA : SAP_REPORT_BYN_DELTA.CSV → sdbtdir3_aprm_dbo.sap_report_byn_delta_voice",
      "Type": "Task",
      "Resource": "arn:aws:states:::glue:startJobRun.sync",
      "Parameters": {
        "JobName.$": "States.Format('{}-aprm_det_bt-gljo-extract_2',$.env_prefix)",
        "Arguments": {
        }
      },
      "Catch": [
    ...
    "Extract_3": {
      "Comment": "APRM DELTA : SAP_REPORT_BYN_FINAL.CSV → sdbtdir3_aprm_dbo.sap_report_byn_final_voice",
      "Type": "Task",
      "Resource": "arn:aws:states:::glue:startJobRun.sync",
      "Parameters": {
        "JobName.$": "States.Format('{}-aprm_det_bt-gljo-extract_3',$.env_prefix)",
        "Arguments": {
        }
      },
      "Catch": [
